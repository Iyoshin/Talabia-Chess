...
import src.model.piece.Time;
import src.model.piece.Plus;
...
/**
 * The ChessView class represents the graphical user interface (GUI) for the custom chess variant game.
 * It handles the display of the chessboard, buttons, and pieces. Additionally, it provides methods to update
 * the view based on the game state, such as flipping the board, updating piece positions, and managing icons.
 *
 * The class uses Swing components, including JFrame, JPanel, and JButton, to create the GUI elements.
 * It also utilizes the ActionListener interface to handle button clicks and MouseListener to handle mouse events on the chessboard.
 * 
 * @Author: Yap Jack, Ng Yi Min, Yong Qi Xiang, Lam Yi Yong, Nazhan Harraz
 * @version 12.0
 * since 8-1-2024
 */
...
private JPanel createSquare(Square square) {
  ...
  code by Yong Qi Xiang, Lam Yi Yong */ 
