...
/**
 * The Point Piece class is responsible for movement of the Point chess piece.
 * The Point Piece method checks whether a move is valid, considering the piece's color, direction, and whether the path is blocked.
 * 
 * @Author: Lam Yi Yong, Ng Yi Min, Yong Qi Xiang
 * @version 6.0
 * since 11-1-2024
 */
