/**
 * The Time Piece class is responsible for movement of the Time chess piece.
 * The Time Piece method checks whether a move diagonally is valid,
...
public class Time extends Piece{
    ...
    public boolean isValidMove(ChessBoard chessBoard, Square fromSquare, Square toSquare) {
        ...
        if (deltaX == deltaY || deltaX == -deltaY) {
            ...
            System.out.println("Invalid move: Time piece moves in a diagonal line.");
        }
