/**
 * The Plus Piece class is responsible for movement of the Plus chess piece.
 * The Plus Piece method checks whether a move horizontally or vertically is valid,
 *  considering the piece's color, direction, and whether the path is blocked.
 * 
...
public class Plus extends Piece{
    ...
    if ((deltaX == 0 && deltaY != 0) || (deltaX != 0 && deltaY == 0)) {
            ...
            System.out.println("Invalid move: Plus piece moves in a straight line.");
        }
        return valid;
    }
